...
"""
    ...
    if provider == 'deepseek':
        ...
        response = requests.post("https://api.deepseek.com/chat/completions", headers=headers, json=querystring)
    else:
        querystring = {
    ...
    def _esc(s):
        return (str(s).replace('&', '&amp;').replace('<x', '&lt;x'))

    def _cell(s):
        # allow <br> formatting but neutralise stray angle brackets minimally
    ...
    try:
        ...
        rationale = plan.get('rationale_html', '') or ''
