...
export const KB = [
  ...
  { id: 'data-privacy', title: 'Your data, export & account deletion',
    ...
    text: 'On the Account page under "Your data" you can export everything we hold about you as a JSON file, or permanently delete your account (which removes your data and cancels any active subscription). See the Privacy Policy and Terms (linked in the footer / sign-in). Tool inputs/outputs are stored as run history you can reopen.' },
