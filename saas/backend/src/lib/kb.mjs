...
export const KB = [
  ...
  { id: 'integrations', title: 'Connecting Google (Search Console, GA4, Ads)',
    keywords: ['google', 'connect', 'integration', 'gsc', 'search console', 'ga4', 'analytics', 'ads', 'oauth', 'property', 'account', 'reconnect', 'meta', 'facebook', 'instagram', 'linkedin'],
    text: 'On the Integrations page, one Google sign-in connects all three sources (Search Console, GA4, Google Ads) — it grants every needed scope at once. Then pick the specific property/account for each source (they can point at different ones). These integration tools cost 0 credits because it\'s your own data. If a source shows "Last pull failed" or stops returning data, click Reconnect. A source must have an account selected (shows "Active") to return data. Meta Ads (Facebook & Instagram) and LinkedIn Ads are NOT available yet — they are still being built and show as "Coming soon" on the Integrations page, so they cannot be connected or run. Do not recommend them or give a launch date; Google is the connected-data option today.' },
