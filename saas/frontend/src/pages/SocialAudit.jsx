...
const TOUR_SCORECARD = {
  ...
  competitor_profiles: [
    {
      name: 'monday.com', platforms: ['instagram'], confidence: 'high',
      what_they_do: 'Sells a visual "Work OS" — a configurable platform teams use to run projects, CRM and internal workflows.',
      products_services: ['Work management boards', 'CRM', 'Dev / sprint tooling', 'No-code automations'],
      target_audience: 'Ops and marketing leads at fast-growing SMBs, plus department heads in mid-market companies who buy without IT.',
      positioning: 'The colourful, easy-to-adopt platform that replaces spreadsheets — sold on speed to value, not depth.',
      differentiators: ['Highly visual, colour-coded boards', 'Templates for every department', 'Automations with no code'],
      topics_owned: ['Workflow automation', 'Replacing spreadsheets', 'Team visibility'],
      content_pillars: ['Automation demos', 'Customer stories', 'Product launches', 'Work culture humour'],
      messaging_tone: 'Bold and upbeat, short declarative captions with heavy emoji use. Messaging is benefit-led ("get your week back") rather than feature-led.',
      audience_engagement: 'Posts ~6 times a week with a video-heavy mix. Leans on saveable automation demos and colour-blocked thumbnails, and consistently replies to comments with product tips.',
      posts_analyzed: 18,
    },
    {
      name: 'ClickUp', platforms: ['instagram'], confidence: 'high',
      what_they_do: 'Offers an all-in-one productivity suite bundling tasks, docs, goals and chat into a single app.',
      products_services: ['Tasks & projects', 'Docs & wikis', 'Goals / OKRs', 'AI assistant'],
      target_audience: 'Productivity-obsessed individual users and small teams; a strong creator/freelancer following.',
      positioning: 'The "one app to replace them all" consolidator — priced and pitched against paying for multiple tools.',
      differentiators: ['Breadth of features at a low price', 'Aggressive shipping cadence', 'Strong creator community'],
      topics_owned: ['Tool consolidation', 'Productivity hacks', 'AI at work'],
      content_pillars: ['Sub-15s feature demos', 'Productivity tips', 'Meme / relatable work humour', 'Release notes'],
      messaging_tone: 'Punchy, meme-fluent and slightly irreverent. Captions are hook-first and written for a scrolling feed, with a clear "try it free" CTA.',
      audience_engagement: 'The most prolific of the set at ~7 posts a week, almost entirely short-form video. Uses hooks in the first second, pinned comments for links, and re-shares user content.',
      posts_analyzed: 21,
    },
  ],
