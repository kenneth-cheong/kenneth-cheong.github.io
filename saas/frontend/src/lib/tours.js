...
const SAMPLE_RESULTS = {
  ...
  competitors: {
    result: {
      source: 'live',
      sections: [
        { type: 'heading', text: 'Competitors for: project management software' },
        stats('', [
          { label: 'Competitors found', value: 5, tone: 'blue' },
          { label: 'Keywords analysed', value: 1, tone: 'slate' },
          { label: 'Keywords you rank for', value: '1 of 1', tone: 'green' },
          { label: 'Your best position', value: '#7', tone: 'blue' },
        ]),
        { type: 'table', title: 'SERP position overlap', columns: ['Competitor', 'project management software'], rows: [
          { Competitor: 'atlassian.com', 'project management software': '#1' },
          { Competitor: 'monday.com', 'project management software': '#2' },
          { Competitor: 'clickup.com', 'project management software': '#4' },
          { Competitor: 'asana.com (you)', 'project management software': '#7' },
          { Competitor: 'smartsheet.com', 'project management software': '#9' },
          { Competitor: 'wrike.com', 'project management software': '#12' },
        ] },
        { type: 'select', name: 'compareWith', max: 3,
          title: 'Compare yourself against them',
          note: 'Pick up to 3 and we’ll pull every keyword asana.com and they BOTH rank for, side by side with each side’s position.',
          options: [
            { value: 'atlassian.com', label: 'atlassian.com', meta: '1 keyword shared' },
            { value: 'monday.com', label: 'monday.com', meta: '1 keyword shared' },
            { value: 'clickup.com', label: 'clickup.com', meta: '1 keyword shared' },
          ],
...
const OUTPUT_BLURB = {
  ...
  competitors: 'Who ranks for the same searches as you, where each of them sits in Google, and where your own site lands among them. Tick two or three to see every keyword you both rank for, side by side.',
