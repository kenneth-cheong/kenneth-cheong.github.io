...
export function startPlatformTour() {
  const steps = [
    ...
    { element: '[data-tour="nav-/tracking"]', popover: { title: 'Rank tracking', description: 'Add keywords and we’ll track their Google positions over time — charted, no need to re-run by hand.', side: 'bottom', align: 'start' } },
