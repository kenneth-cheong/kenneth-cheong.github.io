      ...
      <div className="flex max-h-[88vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <div className="space-y-3 overflow-y-auto px-6 py-5 text-sm leading-relaxed text-slate-700">
          <p className="rounded-lg border border-slate-200 bg-slate-50 p-3">
            ...
            the owner/operator of Digimetrics (the &ldquo;Company&rdquo;); and you / your organisation (the
            &ldquo;Trial User&rdquo;). Together, the &ldquo;Parties&rdquo;.
          </p>
          ...
          <Section n="3" title="Trial Credits">
            <p>As part of the free trial, the Trial User will receive 2,500 Digimetrics credits, with an estimated value of $99. These credits are provided free of charge for trial and evaluation purposes only. The credits:</p>
          ...
          <Section n="7" title="Feedback">
            ...
            <p>The Trial User shall not disclose any confidential, sensitive or third-party information in its feedback unless it has the right to do so.</p>
          </Section>
          ...
          <Section n="13" title="Survival">
            <p>The confidentiality, intellectual property, feedback, restriction of use and limitation of liability provisions shall continue to apply even after the free trial ends.</p>
          </Section>
          ...
          <Section n="15" title="Acceptance">
            <p>By clicking the &ldquo;Accept&rdquo; button, creating a trial account, accessing Digimetrics, or using the free trial credits, the Trial User agrees to be bound by this Agreement.</p>
          </Section>
        </div>
